...
const translations = {
  ...
  de: {
    ...
    "hero.subtitle":
      "CycloWatt ist dein erschwinglicher und unkomplizierter Powermeter. Mit modernster Technologie bringen wir Präzision in dein Raderlebnis. Unser Powermeter ist nahtlos in die Schuhplatte integriert: in Sekunden installiert und mühelos zwischen verschiedenen Fahrrädern wechselbar.",
    ...
    "features.technology.description":
      "CycloWatt verbindet sich nahtlos über Bluetooth mit deinem Fahrradcomputer. Einfach aufzuladen, bietet es bis zu X Stunden Akkulaufzeit bei zuverlässiger Konnektivität.",

    // CTA Section
    "cta.title": "Fahre mit Präzision",
    "cta.description":
      "Schließen Sie sich anderen Radfahrern an, die ihr Training bereits mit CycloWatt transformiert haben. Starten Sie heute und erleben Sie den Unterschied, den Präzision macht.",
